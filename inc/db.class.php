...
class MySQL {
	...
	var $lastInsert;			// Holds the ID of the last insert
	
	var $hostname;	// MySQL Hostname
	var $username = 'webmech_smtrack';	// MySQL Username
	var $password = '*SP7~}]]B3We';	// MySQL Password
	var $database = 'webmech_smtrack';	// MySQL Database
