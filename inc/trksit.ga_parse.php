...
class trksit_GA_Parse
{
  ...
  function __construct($global_cookie) {
	   ...
	   if (isset($_POST["__utma"]) and isset($_POST["__utmz"])) {
	       $this->ParseCookies();
       }
  ...
  // Parse __utmz cookie
  list($domain_hash,$timestamp, $session_number, $campaign_numer, $campaign_data) = split('[\.]', $_POST["__utmz"],5);
  ...
  list($domain_hash,$random_id,$time_initial_visit,$time_beginning_previous_visit,$time_beginning_current_visit,$session_counter) = split('[\.]', $_POST["__utma"]);
  ...
  list($domain_hash,$pages_viewed,$garbage,$time_beginning_current_session) = split('[\.]', $_POST["__utmb"]);
