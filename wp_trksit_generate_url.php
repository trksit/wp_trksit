	...
	<div class="trksit_col left">
		...
		<div class="trksit-section">
			...
			<div class="control-group">
			  ...
			  <div class="controls">
			      <input name="meta_title" id="title" type="text" maxlength="100" value="<?php echo substr($trksit->getTitle(), 0, 100);?>">
			  </div>
			</div>
			<div class="control-group">
			  ...
			  <div class="controls">
				  <textarea name="meta_description" id="description" rows="5" maxlength="255"><?php echo substr($trksit->getDescription(), 0, 157); if(strlen($trksit->getDescription()) > 157){echo "...";}?></textarea>
			  </div>
			</div>
		</div>
